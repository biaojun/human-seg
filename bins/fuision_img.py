...
if __name__ == '__main__':
    ...
    out_dir = r"G:\deep_learning_data\EG_dataset\data_aug_{}".format(img_num)
    portarit_root = r"G:\deep_learning_data\EG_dataset\dataset\training"
    coco_root = r"G:\deep_learning_data\coco_2017"
