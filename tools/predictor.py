...
class Predictor(object):
    ...
    def save_img(path_img, img_src):
        ...
        cv2.imencode('.png', img_src)[1].tofile(path_img)
...
if __name__ == '__main__':
    ...
    path_ckpt = r"D:\study\cv\project\pro\深度之眼：图像分割\seg_06_课堂课件\seg_06_课堂课件\results\09-11_20-49\checkpoint_best.pkl"
    root_dir = r"D:\study\cv\project\data\dataset\Portrait-dataset-2000\dataset\{}".format(set_name)
