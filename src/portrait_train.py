...
from datasets.portrait_dataset import PortraitDataset2000, PortraitDataset34427
...
parser.add_argument('--data_root_dir', default=r"D:\study\cv\project\data\dataset\Portrait-dataset-2000\dataset",
                    help="path to your dataset")
parser.add_argument('--ext_dir', default=r"G:\deep_learning_data\14w_matting",
                    help="path to your dataset")
parser.add_argument('--fusion_dir', default=r"D:\study\cv\project\data\dataset\Portrait-dataset-2000\dataset",
                    help="path to your dataset")
...
if __name__ == '__main__':
    ...
    path_model_101 = r'D:\study\cv\project\data\pretrained_model\resnet101-5d3b4d8f.pth'  # bisenet
    ...
    if cfg.is_warmup:
        # 注意，如果有这段warmup代码，一定要到trainer中修改 scheduler.step(),有多少个iteration
